...
export const PAGES = {
  ...
  combos: {
    ...
    title: 'Combos',
    navLabel: 'Combos',
    load: () => import('./pages/combos.js?v=20260708-11'),
  },
  endgames: {
    id: 'endgames',
    title: 'Endgames',
    navLabel: 'Endgames',
    load: () => import('./pages/endgames.js?v=20260707-8'),
  },
  'sponsor-endgames': {
    id: 'sponsor-endgames',
    title: 'Sponsor Endgames',
    navLabel: 'Sponsor Endgames',
    load: () => import('./pages/sponsor-endgames.js?v=20260707-6'),
  },
  icons: {
    id: 'icons',
    title: 'Icons',
    navLabel: 'Icons',
    load: () => import('./pages/icons.js?v=20260708-4'),
  },
  actions: {
    id: 'actions',
    title: 'Actions',
    navLabel: 'Actions',
    load: () => import('./pages/actions.js?v=20260708-11'),
  },
  predictors: {
    id: 'predictors',
    title: 'Predictors',
  ...
  build: {
    ...
    title: 'Build',
    navLabel: 'Build',
    load: () => import('./pages/build.js?v=20260708-8'),
  },
};
