...
export const PAGES = {
  home: {
    ...
    title: 'Home',
    navLabel: 'Home',
    load: () => import('./pages/home.js?v=20260731-1'),
  },
  cards: {
    id: 'cards',
    title: 'Cards',
    navLabel: 'Cards',
    load: () => import('./pages/cards.js?v=20260731-2'),
  },
  'opening-hand': {
    id: 'opening-hand',
    title: 'Opening Hand',
  ...
  endgames: {
    ...
    title: 'Endgames',
    navLabel: 'Endgames',
    load: () => import('./pages/endgames.js?v=20260731-2'),
  },
  'sponsor-endgames': {
    id: 'sponsor-endgames',
    title: 'Sponsor Endgames',
    navLabel: 'Sponsor Endgames',
    load: () => import('./pages/sponsor-endgames.js?v=20260731-2'),
  },
  icons: {
    id: 'icons',
    title: 'Icons',
  ...
  'mw-action-cards': {
    ...
    load: () => import('./pages/mw-action-cards.js?v=20260812-2'),
  },
  predictors: {
    id: 'predictors',
    title: 'Predictors',
    navLabel: 'Predictors',
    load: () => import('./pages/predictors.js?v=20260731-2'),
  },
  build: {
    id: 'build',
    title: 'Build',
    navLabel: 'Build',
    load: () => import('./pages/build.js?v=20260731-1'),
  },
  conservation: {
    id: 'conservation',
    title: 'Conservation',
    navLabel: 'Conservation',
    load: () => import('./pages/conservation.js?v=20260731-2'),
  },
  scoring: {
    id: 'scoring',
    title: 'Scoring',
    navLabel: 'Scoring',
    load: () => import('./pages/scoring.js?v=20260731-2'),
  },
  workers: {
    id: 'workers',
    title: 'Workers',
    navLabel: 'Workers',
    load: () => import('./pages/workers.js?v=20260731-2'),
  },
  players: {
    id: 'players',
    title: 'Players',
