...
export const PAGES = {
  ...
  cards: {
    ...
    title: 'Cards',
    navLabel: 'Cards',
    load: () => import('./pages/cards.js?v=20260705-2'),
  },
  'opening-hand': {
    id: 'opening-hand',
    title: 'Opening Hand',
    navLabel: 'Opening Hand',
    load: () => import('./pages/opening-hand.js?v=20260705-2'),
  },
  maps: {
    id: 'maps',
    title: 'Maps',
    navLabel: 'Maps',
    load: () => import('./pages/maps.js?v=20260705-2'),
  },
  combos: {
    id: 'combos',
    title: 'Combos',
    navLabel: 'Combos',
    load: () => import('./pages/combos.js?v=20260705-2'),
  },
  endgames: {
    id: 'endgames',
    title: 'Endgames',
    navLabel: 'Endgames',
    load: () => import('./pages/endgames.js?v=20260705-2'),
  },
  'sponsor-endgames': {
    id: 'sponsor-endgames',
    title: 'Sponsor Endgames',
    navLabel: 'Sponsor Endgames',
    load: () => import('./pages/sponsor-endgames.js?v=20260705-2'),
  },
  icons: {
    id: 'icons',
    title: 'Icons',
    navLabel: 'Icons',
    load: () => import('./pages/icons.js?v=20260705-2'),
  },
  build: {
    id: 'build',
    title: 'Build',
    navLabel: 'Build',
    load: () => import('./pages/build.js?v=20260705-3'),
  },
};
